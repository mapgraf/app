<b>*** Поочерёдное открытие панелей с бесплатной и платной версии плагина, вызывает ошибку из-за конфликта версий рендер-ядра. Решается перезагрузкой страницы (F5) </b>
